import svgPaths from "./svg-cpfj4nmo5d";
...
function TopicsDropdown() {
  return (
    <div className="absolute contents left-[72px] top-[522px]" data-name="topics dropdown">
      ...
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[1.2] left-[calc(12.5%-85px)] not-italic text-[#003b3c] text-[20px] text-nowrap top-[539px] whitespace-pre">{`Shipping & Returns`}</p>
...
export default function ContactUsTopicChosen() {
  return (
    <div className="bg-white relative size-full" data-name="contact us topic chosen">
      ...
      <Frame6 />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[1.2] left-[calc(20.83%-259px)] not-italic text-[#003b3c] text-[32px] text-nowrap top-[695px] whitespace-pre">Is this what you are looking for?</p>
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[1.2] left-[calc(20.83%-259px)] not-italic text-[#003b3c] text-[20px] text-nowrap top-[793px] whitespace-pre">{`Frequently asked shipping & returns question 1?`}</p>
      ...
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[1.2] left-[calc(20.83%-259px)] not-italic text-[#003b3c] text-[20px] text-nowrap top-[876px] whitespace-pre">{`Frequently asked shipping & returns question 2?`}</p>
      ...
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[1.2] left-[calc(20.83%-259px)] not-italic text-[#003b3c] text-[20px] text-nowrap top-[956px] whitespace-pre">{`Frequently asked shipping & returns question 3?`}</p>
      ...
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[1.2] left-[calc(16.67%-199px)] not-italic text-[#003b3c] text-[20px] text-nowrap top-[1038px] whitespace-pre">{`Frequently asked shipping & returns questio4?`}</p>
