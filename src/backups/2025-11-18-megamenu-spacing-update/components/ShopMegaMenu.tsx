            ...
            <div className="flex gap-[32px]">
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-start gap-[12px]">
                          <span className={`flex-1 font-['Inter',sans-serif] font-medium text-[15px] ${
                            item.description ? 'leading-[1.0]' : 'leading-[1.3]'
                          } ${
                        ...
                        {item.description && (
                          <div className="pr-[28px] mt-[5px]">
                            <p className="font-['Inter',sans-serif] text-[12px] text-[rgb(64,108,109)] leading-[1.4]">
                              {item.description}
                            </p>
                          </div>
                        )}
                  ...
                  {leftMenuItems.slice(4).map((item) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="font-['Inter',sans-serif] text-[15px] text-[#003b3c] group-hover:text-[#009296] transition-colors">
                          {item.label}
                        </span>
                      </button>
                    );
              ...
              <div className="flex-shrink-0 w-[360px] flex flex-col gap-[20px]">
                ...
                <div className="bg-[#EBF6F4] rounded-[10px] p-[24px]">
                  ...
                  <p className="font-['Inter',sans-serif] text-[13px] text-[rgb(64,108,109)] leading-[1.6] mb-[16px]">
